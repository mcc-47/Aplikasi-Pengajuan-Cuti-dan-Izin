...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/manager-fill").hasAnyRole("ADMINHR","MANAGER")
                .antMatchers(HttpMethod.GET, "/api/manager-fill/**").hasAnyRole("MANAGER","EMPLOYEE")
                .antMatchers(HttpMethod.POST, "/api/manager-fill").hasRole("EMPLOYEE")
                .antMatchers(HttpMethod.PUT, "/api/manager-fill/**").hasRole("MANAGER")
                .antMatchers(HttpMethod.DELETE, "/api/manager-fill/**").hasAnyRole("ADMINHR","MANAGER","EMPLOYEE")
